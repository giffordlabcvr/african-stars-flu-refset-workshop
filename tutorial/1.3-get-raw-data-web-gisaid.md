...
### 1.3.1.  Normalize FASTA headers (left of **first `|`**) + de-dupe
...
### 1.3.2. Nextclade QC + clades (on the normalized + deduped FASTA)
...
### 1.3.3. Clean GISAID metadata (safe TSV parsing; split `Location`; normalize dates)

This trims to the fields Augur/Auspice need and derives `date/year/month`.
